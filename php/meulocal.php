...
<head>
    ...
    <link rel="stylesheet" href="../css/meulocal.css">
    ...
    <script src="../js/meulocal.js"></script>
</head>
    ...
    <main>
        ...
        <form method="POST" action="">
            <div class="como-chegar">
                <input name="pesquisar_linha" type="text" placeholder="Digite local ou endereço"
        ...
        <section class="numero">
            <div class="flexivel">
                <div class="botao">
                    <button class="enviar" type="button">0601</button>
                </div>

                <a href="#">
                    <h1>Linha A</h1>
                </a>
                <p> Volta para estação </p>
            </div>
        </section>
        ...
        <section class="numero">
            <div class="flexivel">
                <div class="botao">
                    <button class="enviar" type="button">0242</button>
                </div>
