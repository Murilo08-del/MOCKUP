...
-- Tabela de Paradas (Estações de cada linha)
...
-- Inserir algumas paradas de exemplo (Linha A - Ferrovia Central)
INSERT INTO paradas (linha_id, nome_parada, ordem, tempo_parada_minutos) VALUES
